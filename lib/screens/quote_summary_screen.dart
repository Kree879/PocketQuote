                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _SummaryRow(
                          ...
                          amount: state.baseMaterialsCost,
                          context: context,
                          currencySymbol: state.currencySymbol,
                        ),
                        if (state.markupPercentage > 0) ...[
                          ...
                          _SummaryRow(
                            title:
                                'Material Markup (${state.markupPercentage}%)',
                            amount: state.materialsMarkupCost,
                            context: context,
                            currencySymbol: state.currencySymbol,
                          ),
                        ],
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: Theme.of(context).textTheme.displayMedium
                                  ?.copyWith(color: catInfo.glowColor),
                            ),
                          ],
                        ),
